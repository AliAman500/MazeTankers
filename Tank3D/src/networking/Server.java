...
public class Server {
	...
	public Server() throws Exception {
		server = new DatagramSocket(9876, InetAddress.getByName("192.168.2.35"));
		...
		while(true) {
			...
			case CONNECT:
				...
				System.out.println("Sent connection approval to client (" + connectPacket.address + ":" + connectPacket.port + ")");
				break;
			case CREATE_ROOM:
				break;
			case JOIN_ROOM:
